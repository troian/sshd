...
{
	channel_cb_.userdata                           = this;
	channel_cb_.channel_data_function              = chan_data_cb_ext;
	channel_cb_.channel_eof_function               = chan_eof_cb_ext;
	channel_cb_.channel_close_function             = chan_close_cb_ext;
	channel_cb_.channel_signal_function            = chan_sig_cb_ext;
	channel_cb_.channel_exit_status_function       = chan_exit_status_cb_ext;
	channel_cb_.channel_exit_signal_function       = chan_exit_sig_cb_ext;
	channel_cb_.channel_pty_request_function       = nullptr;
	channel_cb_.channel_shell_request_function     = nullptr;
	channel_cb_.channel_auth_agent_req_function    = nullptr;
	channel_cb_.channel_x11_req_function           = nullptr;
	channel_cb_.channel_pty_window_change_function = nullptr;
	channel_cb_.channel_exec_request_function      = nullptr;
	channel_cb_.channel_env_request_function       = nullptr;
	channel_cb_.channel_subsystem_request_function = nullptr;

	ssh_callbacks_init(&channel_cb_);
}
